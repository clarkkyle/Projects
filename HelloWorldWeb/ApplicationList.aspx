<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ApplicationList.aspx.cs" Inherits="HelloWorldWeb.ApplicationList" %>
...
<body>
    ...
    <div>
        ...
        <asp:GridView ID="gvApplicationList" runat="server" DataKeyNames="ApplicationID" AutoGenerateColumns="False" OnRowCommand="gvApplicationList_RowCommand">
            <EmptyDataTemplate>
            ...
            <Columns>
                ...
                <asp:ButtonField HeaderText="Edit" Text="Edit" CommandName="EditApp"/>
                <asp:ButtonField HeaderText="Delete" Text="Delete" CommandName="DeleteApp"/>

            </Columns>
        </asp:GridView>
        <br />
         <asp:Panel ID="pnlApplication" runat="Server" Visible="false">
        <table>
            <tr>
                <td>First Name:</td>
                <td>
